...
{
    public class EspecialidadesPorServicoPorClienteRepository : RepositoryBase<EspecialidadesPorServicoPorCliente>, IEspecialidadesPorServicoPorClienteRepository
    {
    }
}
